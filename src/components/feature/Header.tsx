      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-3">
          ...
          <Link to="/" className="flex items-center gap-3 cursor-pointer">
            <div className="w-10 h-10 bg-midnight dark:bg-peach rounded-full flex items-center justify-center text-cream dark:text-midnight font-bold text-base">
              YF
            </div>
            <div>
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            >
              ...
              {activeDropdown === 'about' && (
                <div className="absolute top-full left-0 mt-2 w-52 bg-cream dark:bg-darkmode-bg border border-midnight/10 dark:border-white/10 rounded-xl shadow-lux overflow-hidden">
            ...
            >
              <button
                className={`px-3 py-2 rounded-xl hover:bg-peach/50 transition cursor-pointer whitespace-nowrap flex items-center gap-1 text-sm ${isActive('/programs') ? 'bg-peach/30' : ''}`}
              >
                Programs
                <i className={`ri-arrow-down-s-line transition-transform ${activeDropdown === 'programs' ? 'rotate-180' : ''}`}></i>
              </button>
              {activeDropdown === 'programs' && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-cream dark:bg-darkmode-bg border border-midnight/10 dark:border-white/10 rounded-xl shadow-lux overflow-hidden">
                  <Link to="/programs" className="block px-4 py-2.5 hover:bg-peach/50 transition cursor-pointer text-sm font-semibold border-b border-midnight/10">All Programs</Link>
            ...
            >
              ...
              {activeDropdown === 'involved' && (
                <div className="absolute top-full left-0 mt-2 w-56 bg-cream dark:bg-darkmode-bg border border-midnight/10 dark:border-white/10 rounded-xl shadow-lux overflow-hidden">
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-cream/95 dark:bg-darkmode-bg/95 p-4 border-t border-midnight/10 dark:border-white/10">
            <Link to="/" className="block py-2.5 px-2 rounded-lg hover:bg-peach/50 font-semibold transition cursor-pointer text-sm">
              Home
            </Link>
            <Link to="/about" className="block py-2.5 px-2 rounded-lg hover:bg-peach/50 font-semibold transition cursor-pointer text-sm">
              About Us
            </Link>
            <Link to="/programs" className="block py-2.5 px-2 rounded-lg hover:bg-peach/50 font-semibold transition cursor-pointer text-sm">
              All Programs
            </Link>
            <Link to="/youth-services" className="block py-2.5 px-2 rounded-lg hover:bg-peach/50 font-semibold transition cursor-pointer text-sm">
              Youth Empowerment
            </Link>
            <Link to="/family-services" className="block py-2.5 px-2 rounded-lg hover:bg-peach/50 font-semibold transition cursor-pointer text-sm">
              Family Services
            </Link>
            <Link to="/community" className="block py-2.5 px-2 rounded-lg hover:bg-peach/50 font-semibold transition cursor-pointer text-sm">
              Community Engagement
            </Link>
            <Link to="/get-involved" className="block py-2.5 px-2 rounded-lg hover:bg-peach/50 font-semibold transition cursor-pointer text-sm">
              Get Involved
            </Link>
            <Link to="/resources" className="block py-2.5 px-2 rounded-lg hover:bg-peach/50 font-semibold transition cursor-pointer text-sm">
              Resources
            </Link>
            <Link to="/get-support" className="block py-2.5 px-2 rounded-lg hover:bg-peach/50 font-semibold transition cursor-pointer text-sm">
              Get Support
            </Link>
            <Link to="/contact" className="block py-2.5 px-2 rounded-lg hover:bg-peach/50 font-semibold transition cursor-pointer text-sm">
              Contact Us
            </Link>
            <Link to="/get-involved#donate" className="block py-2.5 px-2 rounded-lg bg-peach/70 font-bold text-midnight transition cursor-pointer mt-2 text-sm">
              Donate Now
            </Link>
          </div>
        )}
